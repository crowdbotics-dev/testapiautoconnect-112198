...
## Project Structure
    ...
    ├── testapiautoconnect_112198  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112198`
...
2. Clone this repo and `cd testapiautoconnect_112198`
